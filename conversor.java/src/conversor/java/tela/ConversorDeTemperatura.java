...
public class ConversorDeTemperatura extends JFrame {
	...
	public ConversorDeTemperatura() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(ConversorDeTemperatura.class.getResource("/image/temperatures.png")));
		...
		lblPara.setBounds(32, 123, 118, 22);
		...
		txtTemperaturaConvertida.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
		...
		lblNewLabel.setIcon(
				new ImageIcon(ConversorDeTemperatura.class.getResource("/image/icons8-high-temperatures-32.png")));
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel.setForeground(SystemColor.text);
		lblNewLabel.setBounds(40, 0, 353, 64);
